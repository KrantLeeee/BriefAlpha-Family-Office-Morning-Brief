/**
 * Mirror of apps/api/briefalpha_api/fixtures/brief.py for offline / SSR
 * fallback. Keep in sync with the Python fixture when content changes.
 */

import type { Brief, ParseReport, SourceHealth } from "./types";
...
export const demoBrief: Brief = {
  ...
  base_case: {
    ...
    summary:
      "英伟达盘后下调数据中心 Q1 营收指引约 8–10%，[1] 拖累美股科技 beta；腾讯扩大回购授权 50%，[2] 支撑港股互联网估值；联邦官员暗示年内或再加息，[3] 久期定价端面临压力。",
    estimate_label: "隔夜估算",
    estimate_value: "-1.09%",
    estimate_direction: "down",
    estimate_explainer: "英伟达盘后指引下调拖累美股科技仓位；港股互联网吸收腾讯回购利好。",
    evidence_count: 4,
  },
  portfolio_snapshot: {
    as_of_hkt: "2026-04-25 08:24",
    tiles: [
      { ticker: "NVDA", weight_pct: "18.0%", change_pct: "-6.0%", trend: "down", color: "treemap.nvda", row: 0, col_start: 0, col_span: 209 },
      { ticker: "0700.HK", label: "0700", weight_pct: "15.0%", change_pct: "+2.4%", trend: "up", color: "treemap.tencent", row: 0, col_start: 209, col_span: 175 },
      { ticker: "AAPL", weight_pct: "12.0%", change_pct: "-1.6%", trend: "down", color: "treemap.aapl", row: 0, col_start: 384, col_span: 140 },
      { ticker: "MSFT", weight_pct: "10.0%", change_pct: "-0.8%", trend: "down", color: "treemap.msft", row: 0, col_start: 524, col_span: 116 },
      { ticker: "TLT", weight_pct: "10.0%", change_pct: "+0.3%", trend: "up", color: "treemap.tlt", row: 1, col_start: 0, col_span: 142 },
      { ticker: "9988.HK", label: "BABA", weight_pct: "8.0%", change_pct: "+1.1%", trend: "up", color: "treemap.baba", row: 1, col_start: 142, col_span: 114 },
      { ticker: "GLD", weight_pct: "8.0%", change_pct: "+0.4%", trend: "up", color: "treemap.gld", row: 1, col_start: 256, col_span: 114 },
      { ticker: "CASH", weight_pct: "9.0%", change_pct: "0.0%", trend: "flat", color: "treemap.cash", row: 1, col_start: 370, col_span: 128 },
  ...
  judgements: [
    {
      ...
      metadata:
        "SEC EDGAR 04-24 20:15 EDT · 4 来源 · NVDA 18% 核心持仓 · 路透 8% vs 彭博 10%—待复核",
      evidence_count: 4,
      requires_review: true,
      review: { reason: "source_conflict", note: "路透 8% vs 彭博 10%—下调幅度分歧", status: "open", reviewed_at: null },
      no_direct_portfolio_link: false,
      reasoning_chain: {
      ...
      evidence: [
        {
          ...
          title: "英伟达 8-K 指引更新",
          quote:
            "「…Q1 数据中心营收预期较前次指引下调约 8-10%，主因企业端需求趋缓与超大规模厂商库存正常化…」",
        ...
        },
        {
          ...
          title: "来源对下调幅度有分歧",
          quote:
            "路透：「英伟达下调 Q1 数据中心营收指引 8%」 · 彭博：「较一致预期下调约 10%」",
      ...
      supplementary_sources: [
        { evidence_id: "ev_axios_recap", label: "Axios · 后续报道", source_link: "briefalpha://demo/ev_axios_recap", link_kind: "internal_demo" },
        { evidence_id: "ev_yfinance_quote", label: "yfinance · 盘后报价", source_link: "briefalpha://demo/ev_yfinance_quote", link_kind: "internal_demo" },
      ],
      suggested_questions: ["为什么报道的数字不同？", "触发人工复核的阈值是什么？"],
    },
    {
      id: "j2",
      rank: 2,
      ...
      evidence: [
        {
          ...
          title: "腾讯控股回购授权公告",
          quote:
            "「董事会决议将 2026 年股份回购授权上限从 1,000 亿港元提高至 1,500 亿港元…」",
      ...
      supplementary_sources: [
        { evidence_id: "ev_scmp_followup", label: "SCMP · 后续评论", source_link: "briefalpha://demo/ev_scmp_followup", link_kind: "internal_demo" },
      ],
      suggested_questions: ["回购节奏会如何影响 9988.HK / 3690.HK 的同主题仓位？"],
    },
    {
      id: "j3",
      rank: 3,
      ...
      reasoning_chain: {
        ...
        conclusion: "关注今夜 PCE 数据报告与上言一致性",
      },
      evidence: [
        {
      ...
      supplementary_sources: [],
      suggested_questions: ["Williams 与 Powell 言论是否一致？"],
    },
  ],
  playbook_events: [
    {
...
export const demoSourceHealth: SourceHealth = {
  as_of_hkt: "08:24",
  overall: "ok",
  rows: [
...
export const demoParseReport: ParseReport = {
  filename: "Goldman China Outlook 2026.pdf",
  size_label: "7.2 MB",
  page_count: 28,
  ...
  low_confidence_chunks: [
    { chunk_id: "c_42", page: 12, reason: "OCR confidence 0.62", preview: "数据中心营收 2026 年或..." },
  ],
};
