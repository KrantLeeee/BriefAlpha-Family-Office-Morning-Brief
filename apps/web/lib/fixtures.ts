  ...
  judgements: [
    {
      ...
      supplementary_sources: [
        { evidence_id: "ev_axios_recap", label: "Axios · 后续报道", source_link: "https://www.axios.com/" },
        { evidence_id: "ev_yfinance_quote", label: "yfinance · 盘后报价", source_link: "yfinance://NVDA" },
      ],
    ...
    },
    {
      ...
      supplementary_sources: [
        { evidence_id: "ev_scmp_followup", label: "SCMP · 后续评论", source_link: "https://www.scmp.com/" },
      ],
